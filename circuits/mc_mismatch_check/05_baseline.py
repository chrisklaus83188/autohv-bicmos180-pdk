...
baseline = {
    ...
    "mirror_nmos50_mismatch_only": {
        "circuit": "NMOS5V0 mirror W=4.7u L=1u, Iref 10 uA, Vout 2.5 V, TT, 5.0 V, 27 C",
    ...
    "preregistered_movers": [
        {"quantity": "NMOS5V0 mirror sigma/mu, M=1, N=200", "before": "4.33 %",
        ...
        {"quantity": "NMOS1V8 vth0 process 1-sigma", "before": "8.33 mV",
         "expected_after": "26.7 mV", "why": "derived from corners (rulings C6)"},
        {"quantity": "NMOS1V8 u0 process 1-sigma", "before": "3.33 %",
         "expected_after": "5.67 %", "why": "derived from corners (rulings C6)"},
        {"quantity": "PMOS1V8 u0 process 1-sigma", "before": "3.33 %",
        ...
        {"quantity": "NDMOS20V vto process 1-sigma", "before": "13.3 mV",
         "expected_after": "16.7 mV", "why": "derived from corners (rulings C6)"},
        {"quantity": "NDMOS20V kp process 1-sigma", "before": "3.33 %",
