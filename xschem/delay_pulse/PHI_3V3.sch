...
N 1120 500 1120 580 {}
N 1120 580 1120 740 {}
C {autohv/PMOS3V3.sym} 760 200 2 1 {name=BP model=PMOS3V3 W=0.8u L=0.35u}
...
N 2180 280 2180 240 {}
C {autohv/PMOS3V3.sym} 2360 280 2 1 {name=G2 model=PMOS3V3 W=0.95u L=0.35u}
T {G2} 2300 170 0 0 0.28 0.28 {}
N 2380 280 2380 240 {}
C {autohv/NMOS3V3.sym} 2160 560 0 0 {name=G3 model=NMOS3V3 W=0.4u L=0.35u}
T {G3} 2100 450 0 0 0.28 0.28 {}
C {lab_pin.sym} 2180 560 0 0 {name=lz15 lab=gnd}
C {autohv/NMOS3V3.sym} 2160 740 0 0 {name=G4 model=NMOS3V3 W=0.4u L=0.35u}
