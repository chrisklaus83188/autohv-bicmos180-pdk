...
N 1120 500 1120 580 {}
N 1120 580 1120 740 {}
C {autohv/NMOS50.sym} 760 800 0 0 {name=BP model=NMOS50 W=1.0u L=0.5u}
...
C {autohv/PMOS50.sym} 1840 280 2 1 {name=PI1 model=PMOS50 W=1.15u L=0.5u}
T {PI1} 1780 170 0 0 0.28 0.28 {}
N 1860 280 1860 240 {}
C {autohv/NMOS50.sym} 1840 720 0 0 {name=PI2 model=NMOS50 W=0.5u L=0.5u}
...
N 1660 500 1800 500 {}
C {autohv/PMOS50.sym} 2080 280 2 1 {name=G1 model=PMOS50 W=1.15u L=0.5u}
T {G1} 2020 170 0 0 0.28 0.28 {}
N 2100 280 2100 240 {}
C {autohv/PMOS50.sym} 2080 440 2 1 {name=G2 model=PMOS50 W=1.15u L=0.5u}
T {G2} 2020 330 0 0 0.28 0.28 {}
C {lab_pin.sym} 2100 440 0 0 {name=lz15 lab=vdd}
N 2100 100 2100 240 {}
N 2100 320 2100 400 {}
C {autohv/NMOS50.sym} 2080 700 0 0 {name=G3 model=NMOS50 W=0.5u L=0.5u}
T {G3} 2020 590 0 0 0.28 0.28 {}
N 2100 700 2100 740 {}
C {autohv/NMOS50.sym} 2260 700 0 0 {name=G4 model=NMOS50 W=0.5u L=0.5u}
...
C {autohv/PMOS50.sym} 2480 280 2 1 {name=O1 model=PMOS50 W=1.15u L=0.5u}
T {O1} 2420 170 0 0 0.28 0.28 {}
N 2500 280 2500 240 {}
C {autohv/NMOS50.sym} 2480 720 0 0 {name=O2 model=NMOS50 W=0.5u L=0.5u}
