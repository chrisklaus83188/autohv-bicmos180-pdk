...
S {}
E {}
T {CMP_PIN_5V0} -200 -320 0 0 0.6 0.6 {}
...
C {autohv/PMOS50.sym} 0 0 2 1 {name=mb model=PMOS50 W=\{20u*WSCALE\} L=\{LANA\} M=1}
...
C {autohv/PMOS50.sym} 0 360 2 1 {name=tail model=PMOS50 W=\{20u*WSCALE\} L=\{LANA\} M=2}
...
C {autohv/PMOS50.sym} 280 360 2 1 {name=m1 model=PMOS50 W=\{WIN*FIN\} L=\{LIN*FIN\} M=1}
...
C {autohv/PMOS50.sym} 560 360 2 1 {name=m2 model=PMOS50 W=\{WIN*FIN\} L=\{LIN*FIN\} M=1}
...
C {autohv/NMOS50.sym} 840 360 0 0 {name=m3 model=NMOS50 W=\{10u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
...
C {autohv/NMOS50.sym} 1120 360 0 0 {name=m4 model=NMOS50 W=\{10u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
...
C {autohv/PMOS50.sym} 0 720 2 1 {name=htail model=PMOS50 W=\{20u*WSCALE*HYSK\} L=\{LANA\} M=1}
...
C {autohv/PMOS50.sym} 280 720 2 1 {name=mha model=PMOS50 W=\{20u*WSCALE\} L=0.5u M=1}
...
C {autohv/PMOS50.sym} 560 720 2 1 {name=mhb model=PMOS50 W=\{20u*WSCALE\} L=0.5u M=1}
...
C {autohv/NMOS50.sym} 0 1080 0 0 {name=m5 model=NMOS50 W=\{40u*WSCALE\} L=\{LANA\} M=1}
...
C {autohv/PMOS50.sym} 280 1080 2 1 {name=m6 model=PMOS50 W=\{20u*WSCALE\} L=\{LANA\} M=4}
...
C {autohv/PMOS50.sym} 0 1440 2 1 {name=m7 model=PMOS50 W=\{20u*WSCALE\} L=0.5u M=1}
...
C {autohv/NMOS50.sym} 280 1440 0 0 {name=m8 model=NMOS50 W=\{10u*WSCALE\} L=0.5u M=1}
...
C {autohv/PMOS50.sym} 1120 1800 2 1 {name=ser model=PMOS50 W=4u L=0.5u M=1}
...
C {autohv/PMOS50.sym} 1400 1800 2 1 {name=sh model=PMOS50 W=4u L=0.5u M=1}
...
C {autohv/NMOS50.sym} 0 2160 0 0 {name=sho2 model=NMOS50 W=4u L=0.5u M=1}
