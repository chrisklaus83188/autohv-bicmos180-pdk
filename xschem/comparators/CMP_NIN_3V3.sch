...
S {}
E {}
T {CMP_NIN_3V3} 620 -280 0 0 0.6 0.6 {}
...
C {autohv/NMOS3V3.sym} 340 880 0 1 {name=mb model=NMOS3V3 W=\{10u*WSCALE\} L=\{LANA\} M=1}
T {mb} 280 770 0 0 0.28 0.28 {}
N 320 880 320 920 {}
C {autohv/NMOS3V3.sym} 810 880 0 0 {name=tail model=NMOS3V3 W=\{10u*WSCALE\} L=\{LANA\} M=2}
T {tail} 750 770 0 0 0.28 0.28 {}
N 830 880 830 920 {}
C {autohv/NMOS3V3.sym} 660 560 0 0 {name=m1 model=NMOS3V3 W=\{WIN*FIN\} L=\{LIN*FIN\} M=1}
T {m1} 600 450 0 0 0.28 0.28 {}
C {lab_pin.sym} 680 560 0 0 {name=lz1 lab=vss}
C {autohv/NMOS3V3.sym} 960 560 0 0 {name=m2 model=NMOS3V3 W=\{WIN*FIN\} L=\{LIN*FIN\} M=1}
T {m2} 900 450 0 0 0.28 0.28 {}
C {lab_pin.sym} 980 560 0 0 {name=lz2 lab=vss}
C {autohv/PMOS3V3.sym} 700 200 2 0 {name=m3 model=PMOS3V3 W=\{20u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
T {m3} 640 90 0 0 0.28 0.28 {}
N 680 200 680 160 {}
C {autohv/PMOS3V3.sym} 960 200 2 1 {name=m4 model=PMOS3V3 W=\{20u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
T {m4} 900 90 0 0 0.28 0.28 {}
N 980 200 980 160 {}
C {autohv/PMOS3V3.sym} 1260 200 2 1 {name=m5 model=PMOS3V3 W=\{80u*WSCALE\} L=\{LANA\} M=1}
T {m5} 1200 90 0 0 0.28 0.28 {}
N 1280 200 1280 160 {}
C {autohv/NMOS3V3.sym} 1260 880 0 0 {name=m6 model=NMOS3V3 W=\{10u*WSCALE\} L=\{LANA\} M=4}
T {m6} 1200 770 0 0 0.28 0.28 {}
N 1280 880 1280 920 {}
C {autohv/PMOS3V3.sym} 1560 200 2 1 {name=m7 model=PMOS3V3 W=\{20u*WSCALE\} L=0.5u M=1}
T {m7} 1500 90 0 0 0.28 0.28 {}
N 1580 200 1580 160 {}
C {autohv/NMOS3V3.sym} 1560 880 0 0 {name=m8 model=NMOS3V3 W=\{10u*WSCALE\} L=0.5u M=1}
...
C {autohv/NMOS3V3.sym} 520 880 0 0 {name=sh model=NMOS3V3 W=4u L=0.5u M=1}
T {sh} 460 770 0 0 0.28 0.28 {}
N 540 880 540 920 {}
C {autohv/PMOS3V3.sym} 1400 200 2 1 {name=sho2 model=PMOS3V3 W=4u L=0.5u M=1}
T {sho2} 1340 90 0 0 0.28 0.28 {}
N 1420 200 1420 160 {}
C {autohv/NMOS3V3.sym} 300 560 0 0 {name=ser model=NMOS3V3 W=4u L=0.5u M=1}
...
C {autohv/NMOS3V3.sym} 300 1640 0 0 {name=htail model=NMOS3V3 W=\{10u*WSCALE*HYSK\} L=\{LANA\} M=1}
...
C {autohv/NMOS3V3.sym} 600 1640 0 0 {name=mha model=NMOS3V3 W=\{10u*WSCALE\} L=0.5u M=1}
...
C {autohv/NMOS3V3.sym} 900 1640 0 0 {name=mhb model=NMOS3V3 W=\{10u*WSCALE\} L=0.5u M=1}
