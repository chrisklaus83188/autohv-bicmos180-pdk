...
C {autohv/NMOS33.sym} 340 880 0 1 {name=mb model=NMOS33 W=\{10u*WSCALE\} L=\{LANA\} M=1}
...
C {autohv/PMOS33.sym} 700 200 2 0 {name=m3 model=PMOS33 W=\{20u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
...
C {autohv/NMOS33.sym} 520 880 0 0 {name=sh model=NMOS33 W=4u L=0.5u M=1}
...
C {autohv/NMOS33.sym} 300 1640 0 0 {name=htail model=NMOS33 W=\{10u*WSCALE*HYSK\} L=\{LANA\} M=1}
...
C {autohv/NMOS33.sym} 600 1640 0 0 {name=mha model=NMOS33 W=\{10u*WSCALE\} L=0.5u M=1}
...
C {autohv/NMOS33.sym} 900 1640 0 0 {name=mhb model=NMOS33 W=\{10u*WSCALE\} L=0.5u M=1}
