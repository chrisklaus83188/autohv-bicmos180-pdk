...
S {}
E {}
T {CMP_NIN_3V3} -1150 -260 0 0 0.6 0.6 {}
...
C {autohv/NMOS33.sym} 300 880 0 0 {name=mb model=NMOS33 W=\{10u*WSCALE\} L=\{LANA\} M=1}
T {mb} 245 775 0 0 0.28 0.28 {}
N 320 880 320 920 {}
C {autohv/NMOS33.sym} 810 880 0 0 {name=tail model=NMOS33 W=\{10u*WSCALE\} L=\{LANA\} M=2}
T {tail} 755 775 0 0 0.28 0.28 {}
N 830 880 830 920 {}
C {autohv/NMOS33.sym} 660 560 0 0 {name=m1 model=NMOS33 W=\{WIN*FIN\} L=\{LIN*FIN\} M=1}
T {m1} 605 455 0 0 0.28 0.28 {}
C {lab_pin.sym} 680 560 0 0 {name=lz1 lab=vss}
C {autohv/NMOS33.sym} 960 560 0 0 {name=m2 model=NMOS33 W=\{WIN*FIN\} L=\{LIN*FIN\} M=1}
T {m2} 905 455 0 0 0.28 0.28 {}
C {lab_pin.sym} 980 560 0 0 {name=lz2 lab=vss}
C {autohv/PMOS33.sym} 660 200 2 1 {name=m3 model=PMOS33 W=\{20u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
T {m3} 605 95 0 0 0.28 0.28 {}
N 680 200 680 160 {}
C {autohv/PMOS33.sym} 960 200 2 1 {name=m4 model=PMOS33 W=\{20u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
T {m4} 905 95 0 0 0.28 0.28 {}
N 980 200 980 160 {}
C {autohv/PMOS33.sym} 1260 200 2 1 {name=m5 model=PMOS33 W=\{80u*WSCALE\} L=\{LANA\} M=1}
T {m5} 1205 95 0 0 0.28 0.28 {}
N 1280 200 1280 160 {}
C {autohv/NMOS33.sym} 1260 880 0 0 {name=m6 model=NMOS33 W=\{10u*WSCALE\} L=\{LANA\} M=4}
T {m6} 1205 775 0 0 0.28 0.28 {}
N 1280 880 1280 920 {}
C {autohv/PMOS33.sym} 1560 200 2 1 {name=m7 model=PMOS33 W=\{20u*WSCALE\} L=0.5u M=1}
T {m7} 1505 95 0 0 0.28 0.28 {}
N 1580 200 1580 160 {}
C {autohv/NMOS33.sym} 1560 880 0 0 {name=m8 model=NMOS33 W=\{10u*WSCALE\} L=0.5u M=1}
T {m8} 1505 775 0 0 0.28 0.28 {}
N 1580 880 1580 920 {}
C {autohv/PMOS33.sym} -900 200 2 1 {name=ei1p model=PMOS33 W=4u L=0.5u M=1}
T {ei1p} -955 95 0 0 0.28 0.28 {}
N -880 200 -880 160 {}
C {autohv/NMOS33.sym} -900 880 0 0 {name=ei1n model=NMOS33 W=2u L=0.5u M=1}
T {ei1n} -955 775 0 0 0.28 0.28 {}
N -880 880 -880 920 {}
C {autohv/PMOS33.sym} -600 200 2 1 {name=ei2p model=PMOS33 W=4u L=0.5u M=1}
T {ei2p} -655 95 0 0 0.28 0.28 {}
N -580 200 -580 160 {}
C {autohv/NMOS33.sym} -600 880 0 0 {name=ei2n model=NMOS33 W=2u L=0.5u M=1}
T {ei2n} -655 775 0 0 0.28 0.28 {}
N -580 880 -580 920 {}
C {autohv/NMOS33.sym} -300 880 0 0 {name=sh model=NMOS33 W=4u L=0.5u M=1}
T {sh} -355 775 0 0 0.28 0.28 {}
N -280 880 -280 920 {}
C {autohv/PMOS33.sym} 1400 200 2 1 {name=sho2 model=PMOS33 W=4u L=0.5u M=1}
T {sho2} 1345 95 0 0 0.28 0.28 {}
N 1420 200 1420 160 {}
C {autohv/NMOS33.sym} 300 560 0 0 {name=ser model=NMOS33 W=4u L=0.5u M=1}
...
C {autohv/NMOS33.sym} -900 1460 0 0 {name=htail model=NMOS33 W=\{10u*WSCALE*HYSK\} L=\{LANA\} M=1}
...
C {autohv/NMOS33.sym} -600 1460 0 0 {name=mha model=NMOS33 W=\{10u*WSCALE\} L=0.5u M=1}
...
C {autohv/NMOS33.sym} -300 1460 0 0 {name=mhb model=NMOS33 W=\{10u*WSCALE\} L=0.5u M=1}
