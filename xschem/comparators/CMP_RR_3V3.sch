...
S {}
E {}
T {CMP_RR_3V3} -200 -320 0 0 0.6 0.6 {}
...
C {autohv/NMOS33.sym} 0 0 0 0 {name=rbn model=NMOS33 W=10u L=1u M=1}
...
C {autohv/NMOS33.sym} 280 0 0 0 {name=mir model=NMOS33 W=10u L=1u M=1}
...
C {autohv/PMOS33.sym} 560 0 2 1 {name=rbp model=PMOS33 W=20u L=1u M=1}
...
C {autohv/PMOS33.sym} 840 0 2 1 {name=vc1 model=PMOS33 W=20u L=1u M=1}
...
C {autohv/PMOS33.sym} 1120 0 2 1 {name=vc2 model=PMOS33 W=20u L=1u M=1}
...
C {autohv/NMOS33.sym} 1400 0 0 0 {name=isk model=NMOS33 W=10u L=1u M=1}
...
C {autohv/NMOS33.sym} 0 360 0 0 {name=mtn model=NMOS33 W=20u L=1u M=1}
...
C {autohv/NMOS33.sym} 280 360 0 0 {name=n1 model=NMOS33 W=\{40u*FIN\} L=\{1u*FIN\} M=1}
...
C {autohv/NMOS33.sym} 560 360 0 0 {name=n2 model=NMOS33 W=\{40u*FIN\} L=\{1u*FIN\} M=1}
...
C {autohv/PMOS33.sym} 840 360 2 1 {name=mtp model=PMOS33 W=40u L=1u M=1}
...
C {autohv/PMOS33.sym} 1120 360 2 1 {name=p1 model=PMOS33 W=\{80u*FIN\} L=\{1u*FIN\} M=1}
...
C {autohv/PMOS33.sym} 1400 360 2 1 {name=p2 model=PMOS33 W=\{80u*FIN\} L=\{1u*FIN\} M=1}
...
C {autohv/PMOS33.sym} 0 720 2 1 {name=f1 model=PMOS33 W=60u L=1u M=1}
...
C {autohv/PMOS33.sym} 280 720 2 1 {name=f2 model=PMOS33 W=60u L=1u M=1}
...
C {autohv/PMOS33.sym} 560 720 2 1 {name=cp1 model=PMOS33 W=40u L=1u M=1}
...
C {autohv/PMOS33.sym} 840 720 2 1 {name=cp2 model=PMOS33 W=40u L=1u M=1}
...
C {autohv/NMOS33.sym} 1120 720 0 0 {name=mm1 model=NMOS33 W=\{20u*FIN\} L=\{1u*FIN\} M=1}
...
C {autohv/NMOS33.sym} 1400 720 0 0 {name=mm2 model=NMOS33 W=\{20u*FIN\} L=\{1u*FIN\} M=1}
...
C {autohv/NMOS33.sym} 0 1080 0 0 {name=s2n model=NMOS33 W=40u L=1u M=1}
...
C {autohv/PMOS33.sym} 280 1080 2 1 {name=s2p model=PMOS33 W=40u L=1u M=1}
...
C {autohv/PMOS33.sym} 0 1440 2 1 {name=bp model=PMOS33 W=20u L=0.5u M=1}
...
C {autohv/NMOS33.sym} 280 1440 0 0 {name=bn model=NMOS33 W=10u L=0.5u M=1}
...
C {autohv/NMOS33.sym} 1120 1800 0 0 {name=ser model=NMOS33 W=4u L=0.5u M=1}
...
C {autohv/NMOS33.sym} 1400 1800 0 0 {name=shn model=NMOS33 W=4u L=0.5u M=1}
...
C {autohv/PMOS33.sym} 0 2160 2 1 {name=shp model=PMOS33 W=4u L=0.5u M=1}
...
C {autohv/NMOS33.sym} 280 2160 0 0 {name=sho2 model=NMOS33 W=4u L=0.5u M=1}
