...
S {}
E {}
T {CMP_NIN_1V8} -1150 -260 0 0 0.6 0.6 {}
...
C {autohv/NMOS18.sym} 300 880 0 0 {name=mb model=NMOS18 W=\{10u*WSCALE\} L=\{LANA\} M=1}
...
C {autohv/PMOS18.sym} 660 200 2 1 {name=m3 model=PMOS18 W=\{20u*WSCALE*FIN\} L=\{LANA*FIN\} M=1}
...
N 1580 880 1580 920 {}
C {autohv/PMOS18.sym} -900 200 2 1 {name=ei1p model=PMOS18 W=4u L=0.5u M=1}
T {ei1p} -955 95 0 0 0.28 0.28 {}
N -880 200 -880 160 {}
C {autohv/NMOS18.sym} -900 880 0 0 {name=ei1n model=NMOS18 W=2u L=0.5u M=1}
T {ei1n} -955 775 0 0 0.28 0.28 {}
N -880 880 -880 920 {}
C {autohv/PMOS18.sym} -600 200 2 1 {name=ei2p model=PMOS18 W=4u L=0.5u M=1}
T {ei2p} -655 95 0 0 0.28 0.28 {}
N -580 200 -580 160 {}
C {autohv/NMOS18.sym} -600 880 0 0 {name=ei2n model=NMOS18 W=2u L=0.5u M=1}
T {ei2n} -655 775 0 0 0.28 0.28 {}
N -580 880 -580 920 {}
C {autohv/NMOS18.sym} -300 880 0 0 {name=sh model=NMOS18 W=4u L=0.5u M=1}
...
C {autohv/NMOS18.sym} -900 1460 0 0 {name=htail model=NMOS18 W=\{10u*WSCALE*HYSK\} L=\{LANA\} M=1}
...
C {autohv/NMOS18.sym} -600 1460 0 0 {name=mha model=NMOS18 W=\{10u*WSCALE\} L=0.5u M=1}
...
C {autohv/NMOS18.sym} -300 1460 0 0 {name=mhb model=NMOS18 W=\{10u*WSCALE\} L=0.5u M=1}
