...
S {}
E {}
T {TGB_100R_5V0} 560 170 0 0 0.6 0.6 {}
T {~100 ohm at TT / 5 V / 27 C, worst case over the input level.} 560 220 0 0 0.3 0.3 {}
...
C {autohv/PMOS5V0.sym} 400 240 2 1 {name=XINVP W=21u L=0.5u M=1}
...
C {autohv/NMOS5V0.sym} 400 700 0 0 {name=XINVN W=8.4u L=0.5u M=1}
...
C {autohv/NMOS5V0.sym} 1000 340 0 0 {name=XN W=84u L=0.5u M=1}
...
C {autohv/PMOS5V0.sym} 1000 640 0 0 {name=XP W=70u L=0.5u M=3}
