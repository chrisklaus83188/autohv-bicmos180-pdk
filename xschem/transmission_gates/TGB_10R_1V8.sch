...
S {}
E {}
T {TGB_10R_1V8} 560 170 0 0 0.6 0.6 {}
T {~10 ohm at TT / 1.8 V / 27 C, worst case over the input level.} 560 220 0 0 0.3 0.3 {}
T {Wp/Wn = 2.5, L = 0.18 um. PVT envelope and input window: ../REPORT.md.} 560 255 0 0 0.3 0.3 {}
...
C {ipin.sym} 120 660 0 0 {name=pbn lab=bn sim_pinnumber=4}
C {ipin.sym} 120 740 0 0 {name=pbp lab=bp sim_pinnumber=5}
C {autohv/PMOS1V8.sym} 400 240 2 1 {name=XINVP W=100u L=0.18u M=1}
...
C {autohv/NMOS1V8.sym} 400 700 0 0 {name=XINVN W=40u L=0.18u M=1}
...
C {autohv/NMOS1V8.sym} 1000 340 0 0 {name=XN W=100u L=0.18u M=4}
...
C {lab_pin.sym} 1020 340 0 0 {name=lXNb lab=bn}
C {autohv/PMOS1V8.sym} 1000 640 0 0 {name=XP W=100u L=0.18u M=10}
...
C {lab_pin.sym} 1020 640 0 0 {name=lXPb lab=bp}
