...
S {}
E {}
T {TGB_100R_1V8} 560 170 0 0 0.6 0.6 {}
T {~100 ohm at TT / 1.8 V / 27 C, worst case over the input level.} 560 220 0 0 0.3 0.3 {}
...
C {autohv/PMOS1V8.sym} 400 240 2 1 {name=XINVP W=10u L=0.18u M=1}
...
C {autohv/NMOS1V8.sym} 400 700 0 0 {name=XINVN W=4u L=0.18u M=1}
...
C {autohv/NMOS1V8.sym} 1000 340 0 0 {name=XN W=40u L=0.18u M=1}
...
C {autohv/PMOS1V8.sym} 1000 640 0 0 {name=XP W=100u L=0.18u M=1}
