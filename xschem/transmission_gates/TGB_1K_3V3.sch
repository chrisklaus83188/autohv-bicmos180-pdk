...
S {}
E {}
T {TGB_1K_3V3} 560 170 0 0 0.6 0.6 {}
...
C {autohv/PMOS3V3.sym} 400 240 2 1 {name=XINVP W=1.15u L=0.35u M=1}
...
C {autohv/NMOS3V3.sym} 400 700 0 0 {name=XINVN W=0.46u L=0.35u M=1}
...
C {autohv/NMOS3V3.sym} 1000 340 0 0 {name=XN W=4.6u L=0.35u M=1}
...
C {autohv/PMOS3V3.sym} 1000 640 0 0 {name=XP W=11.5u L=0.35u M=1}
