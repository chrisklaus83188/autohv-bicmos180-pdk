...
S {}
E {}
T {TGB_1K_1V8} 560 170 0 0 0.6 0.6 {}
T {~1 kohm at TT / 1.8 V / 27 C, worst case over the input level.} 560 220 0 0 0.3 0.3 {}
...
C {autohv/PMOS1V8.sym} 400 240 2 1 {name=XINVP W=1u L=0.18u M=1}
...
C {autohv/NMOS1V8.sym} 400 700 0 0 {name=XINVN W=0.4u L=0.18u M=1}
...
C {autohv/NMOS1V8.sym} 1000 340 0 0 {name=XN W=4u L=0.18u M=1}
...
C {autohv/PMOS1V8.sym} 1000 640 0 0 {name=XP W=10u L=0.18u M=1}
