...
C {autohv/PMOS18.sym} 0 -140 2 1 {name=MP1 W=3.6533u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/PMOS18.sym} 200 -140 2 1 {name=MP2 W=3.6533u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS18.sym} 0 140 0 0 {name=MN1 W=0.22u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS18.sym} 200 140 0 0 {name=MN2 W=0.22u L=0.18u M=1 MM_SIGMA=0}
