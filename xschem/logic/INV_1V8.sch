...
S {}
E {}
T {INV_1V8 - implementation generated from circuits/async_logic_design/cells.lib. Do not hand-edit; regenerate with xschem/gen_logic_schematics.py} -120 -330 0 0 0.3 0.3 {layer=4}
N -120 -240 120 -240 {}
N -120 240 120 240 {}
C {lab_pin.sym} -120 -240 0 0 {name=lvdd lab=vdd}
C {lab_pin.sym} -120 240 0 0 {name=lgnd lab=gnd}
C {autohv/PMOS1V8.sym} 0 -140 2 1 {name=MP1 W=2.656u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS1V8.sym} 0 140 0 0 {name=MN1 W=0.5717u L=0.18u M=1 MM_SIGMA=0}
