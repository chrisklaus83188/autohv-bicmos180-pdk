...
S {}
E {}
T {XNOR2_3V3 - implementation generated from circuits/async_logic_design/cells.lib. Do not hand-edit; regenerate with xschem/gen_logic_schematics.py} -120 -330 0 0 0.3 0.3 {layer=4}
N -120 -240 1120 -240 {}
N -120 240 1120 240 {}
C {lab_pin.sym} -120 -240 0 0 {name=lvdd lab=vdd}
C {lab_pin.sym} -120 240 0 0 {name=lgnd lab=gnd}
C {autohv/PMOS3V3.sym} 0 -140 2 1 {name=MP1 W=0.9811u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/PMOS3V3.sym} 200 -140 2 1 {name=MP2 W=0.9811u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/PMOS3V3.sym} 400 -140 2 1 {name=MP3 W=1.2367u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/PMOS3V3.sym} 600 -140 2 1 {name=MP4 W=1.2367u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/PMOS3V3.sym} 800 -140 2 1 {name=MP5 W=1.2367u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/PMOS3V3.sym} 1000 -140 2 1 {name=MP6 W=1.2367u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 0 140 0 0 {name=MN1 W=0.3u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 200 140 0 0 {name=MN2 W=0.3u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 400 140 0 0 {name=MN3 W=0.3u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 600 140 0 0 {name=MN4 W=0.3u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 800 140 0 0 {name=MN5 W=0.3u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 1000 140 0 0 {name=MN6 W=0.3u L=0.35u M=1 MM_SIGMA=0}
