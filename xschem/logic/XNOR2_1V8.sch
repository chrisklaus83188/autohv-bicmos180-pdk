...
S {}
E {}
T {XNOR2_1V8 - implementation generated from circuits/async_logic_design/cells.lib. Do not hand-edit; regenerate with xschem/gen_logic_schematics.py} -120 -330 0 0 0.3 0.3 {layer=4}
N -120 -240 1120 -240 {}
N -120 240 1120 240 {}
C {lab_pin.sym} -120 -240 0 0 {name=lvdd lab=vdd}
C {lab_pin.sym} -120 240 0 0 {name=lgnd lab=gnd}
C {autohv/PMOS1V8.sym} 0 -140 2 1 {name=MP1 W=1.2774u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/PMOS1V8.sym} 200 -140 2 1 {name=MP2 W=1.2774u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/PMOS1V8.sym} 400 -140 2 1 {name=MP3 W=1.4003u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/PMOS1V8.sym} 600 -140 2 1 {name=MP4 W=1.4003u L=0.18u M=1 MM_SIGMA=0}
C {lab_pin.sym} 620 -100 0 0 {name=lP4d lab=k1}
C {lab_pin.sym} 560 -140 0 0 {name=lP4g lab=bbar}
N 620 -180 620 -240 {}
C {lab_pin.sym} 620 -140 0 0 {name=lP4b lab=vdd}
C {autohv/PMOS1V8.sym} 800 -140 2 1 {name=MP5 W=1.4003u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/PMOS1V8.sym} 1000 -140 2 1 {name=MP6 W=1.4003u L=0.18u M=1 MM_SIGMA=0}
C {lab_pin.sym} 1020 -100 0 0 {name=lP6d lab=k2}
C {lab_pin.sym} 960 -140 0 0 {name=lP6g lab=b}
N 1020 -180 1020 -240 {}
C {lab_pin.sym} 1020 -140 0 0 {name=lP6b lab=vdd}
C {autohv/NMOS1V8.sym} 0 140 0 0 {name=MN1 W=0.275u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS1V8.sym} 200 140 0 0 {name=MN2 W=0.275u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS1V8.sym} 400 140 0 0 {name=MN3 W=0.275u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS1V8.sym} 600 140 0 0 {name=MN4 W=0.275u L=0.18u M=1 MM_SIGMA=0}
C {lab_pin.sym} 620 100 0 0 {name=lN4d lab=m1}
C {lab_pin.sym} 560 140 0 0 {name=lN4g lab=bbar}
N 620 180 620 240 {}
C {lab_pin.sym} 620 140 0 0 {name=lN4b lab=gnd}
C {autohv/NMOS1V8.sym} 800 140 0 0 {name=MN5 W=0.275u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS1V8.sym} 1000 140 0 0 {name=MN6 W=0.275u L=0.18u M=1 MM_SIGMA=0}
C {lab_pin.sym} 1020 100 0 0 {name=lN6d lab=m2}
C {lab_pin.sym} 960 140 0 0 {name=lN6g lab=b}
N 1020 180 1020 240 {}
