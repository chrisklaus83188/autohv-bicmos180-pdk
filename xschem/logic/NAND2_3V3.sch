...
S {}
E {}
T {NAND2_3V3 - implementation generated from circuits/async_logic_design/cells.lib. Do not hand-edit; regenerate with xschem/gen_logic_schematics.py} -120 -330 0 0 0.3 0.3 {layer=4}
N -120 -240 320 -240 {}
N -120 240 320 240 {}
C {lab_pin.sym} -120 -240 0 0 {name=lvdd lab=vdd}
C {lab_pin.sym} -120 240 0 0 {name=lgnd lab=gnd}
C {autohv/PMOS3V3.sym} 0 -140 2 1 {name=MP1 W=1.3719u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/PMOS3V3.sym} 200 -140 2 1 {name=MP2 W=1.3719u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 0 140 0 0 {name=MN1 W=1.4316u L=0.35u M=1 MM_SIGMA=0}
...
C {autohv/NMOS3V3.sym} 200 140 0 0 {name=MN2 W=1.4316u L=0.35u M=1 MM_SIGMA=0}
