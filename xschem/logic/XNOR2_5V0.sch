...
C {autohv/PMOS50.sym} 0 -140 2 1 {name=MP1 W=1.0892u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/PMOS50.sym} 200 -140 2 1 {name=MP2 W=1.0892u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/PMOS50.sym} 400 -140 2 1 {name=MP3 W=1.2316u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/PMOS50.sym} 600 -140 2 1 {name=MP4 W=1.2316u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/PMOS50.sym} 800 -140 2 1 {name=MP5 W=1.2316u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/PMOS50.sym} 1000 -140 2 1 {name=MP6 W=1.2316u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/NMOS50.sym} 0 140 0 0 {name=MN1 W=0.4009u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/NMOS50.sym} 200 140 0 0 {name=MN2 W=0.4009u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/NMOS50.sym} 400 140 0 0 {name=MN3 W=0.4009u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/NMOS50.sym} 600 140 0 0 {name=MN4 W=0.4009u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/NMOS50.sym} 800 140 0 0 {name=MN5 W=0.4009u L=0.5u M=1 MM_SIGMA=0}
...
C {autohv/NMOS50.sym} 1000 140 0 0 {name=MN6 W=0.4009u L=0.5u M=1 MM_SIGMA=0}
