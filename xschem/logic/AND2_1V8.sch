...
C {autohv/PMOS18.sym} 0 -140 2 1 {name=MP1 W=1.8277u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/PMOS18.sym} 200 -140 2 1 {name=MP2 W=1.8277u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/PMOS18.sym} 400 -140 2 1 {name=MP3 W=2.656u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS18.sym} 0 140 0 0 {name=MN1 W=1.4011u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS18.sym} 200 140 0 0 {name=MN2 W=1.4011u L=0.18u M=1 MM_SIGMA=0}
...
C {autohv/NMOS18.sym} 400 140 0 0 {name=MN3 W=0.5717u L=0.18u M=1 MM_SIGMA=0}
