...
* Delta       : rd=1e-09, rs=1e-09, rq=1e-09; renamed NDMOS200_INT -> NDMOS200_D1 because ngspice-45 keeps the FIRST .model definition and would otherwise silently ignore this copy. Every other parameter byte-identical to the PDK card.
