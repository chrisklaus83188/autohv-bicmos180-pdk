...
* Delta       : ; renamed NDMOS200_INT -> NDMOS200_ASIS because ngspice-45 keeps the FIRST .model definition and would otherwise silently ignore this copy. Every other parameter byte-identical to the PDK card.
...
.model NDMOS200_ASIS VDMOS (nchan
+ vto={VTO_NDMOS200_STAT+TC_VTO_NDMOS200*(temper-27)}
+ kp={KP_NDMOS200_STAT*(1+TC_KP_NDMOS200*(temper-27))}
+ lambda=0.005
+ theta=0.12
+ rd={RD_NDMOS200_STAT*(1+TC_RD_NDMOS200*(temper-27))}
+ rs={RS_NDMOS200_STAT*(1+TC_RS_NDMOS200*(temper-27))}
+ rg=6
+ rds=2e+10
+ cgdmax=2.65626e-14
+ cgdmin=6.64064e-15
